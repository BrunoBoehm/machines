...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { description: @sub_category.description, name: @sub_category.name, seo_keywords: @sub_category.seo_keywords, seo_text: @sub_category.seo_text, slug: @sub_category.slug }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { description: @sub_category.description, name: @sub_category.name, seo_keywords: @sub_category.seo_keywords, seo_text: @sub_category.seo_text, slug: @sub_category.slug }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
